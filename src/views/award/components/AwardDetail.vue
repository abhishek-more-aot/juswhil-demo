  ...
  <div class="form-block">
    <div class="source">
      ...
      >
        ...
        <el-form-item label="Link" prop="link" required>
          <el-input
...
import { getAwardById, updateAward, createAward } from "@/api/award";
...
import { defaultAwardData } from "@/api/award";
...
export default class extends Vue {
  ...
  private formData = Object.assign({}, defaultAwardData);
  ...
  created() {
    ...
    if (this.isEdit) {
      ...
      this.formData = Object.assign({}, defaultAwardData);
    }
  ...
  private async fetchData(id: number) {
    try {
      const data: any = await getAwardById(id);
      this.renderKey++;
      this.formData = data;
  ...
  public async saveForm() {
    try {
      ...
      if (this.isEdit) {
        ...
        await updateAward(this.formData.id, this.formData);
      } else {
        await createAward(this.formData);
      }
