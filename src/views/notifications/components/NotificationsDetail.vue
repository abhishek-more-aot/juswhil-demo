...
import { defaultNotificationData } from "@/api/notifications";
...
export default class extends Vue {
  ...
  private formData = Object.assign({}, defaultNotificationData);
  ...
  created() {
    ...
    if (this.isEdit) {
      ...
      this.formData = Object.assign({}, defaultNotificationData);
    }
  ...
  public async saveForm() {
    try {
      ...
      if (this.isEdit) {
        ...
        await updateNotifications(this.formData.id, this.formData);
      } else {
        await createNotifications(this.formData);
      }
