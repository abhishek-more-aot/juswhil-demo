    ...
    <div class="source">
      ...
      >
        ...
        <upload-image
          ...
          @handle-upload="updateBannerImage"
          @handle-remove="removeBannerImage"
         />
...
export default class extends Vue {
  ...
  private postForm = Object.assign({}, defaultBannerData);
  ...
  created() {
    if (this.isEdit) {
      ...
      this.postForm = Object.assign({}, defaultBannerData)
    }
  ...
  private async fetchData(id: number) {
    try {
      const data: any = await getBannerById(id)
      this.postForm = data
      this.renderKey++
  ...
  public async saveForm() {
    try {
      this.loading = true
      if (this.isEdit) {
        await updateBanner(this.postForm.id, this.postForm)
      } else {
        await addBanner(this.postForm)
      }
