<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link to="/gst/add" class="margin-horizontal">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <enabled
            ...
            :url="'/gst/' + scope.row.id"
          />
        </template>
      </el-table-column>

      <el-table-column width="250px" align="center" label="HSN Code" prop="hsncode" />
      ...
      <el-table-column
        ...
        prop="gstPercentage"
      >
        <template slot-scope="scope"> {{ scope.row.gstPercentage }}% </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <router-link :to="'/gst/edit/' + scope.row.id">
...
import { IGSTData } from "@/api/types";
...
export default class extends Vue {
  ...
  private async getList() {
    try {
      ...
      const data: any = await getGst(getQuery(this.listQuery));
      this.list = data.data;
